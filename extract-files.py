...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/bin/hw/android.hardware.gnss-service.mediatek',
     'vendor/lib64/hw/android.hardware.gnss-impl-mediatek.so'): blob_fixup()
        .replace_needed('android.hardware.gnss-V1-ndk_platform.so',
    ...
    'vendor/bin/hw/android.hardware.security.keymint-service.trustkernel': blob_fixup()
        ...
        .replace_needed('android.hardware.security.keymint-V1-ndk_platform.so',
                        'android.hardware.security.keymint-V3-ndk-mtk.so')
    ...
    ('vendor/bin/mnld', 'vendor/lib64/mt6789/libaalservice.so',
    ...
    ('vendor/lib64/hw/mt6789/vendor.mediatek.hardware.camera.isphal@1.0-impl.so',
     'vendor/lib64/hw/mt6789/vendor.mediatek.hardware.camera.isphal@1.1-impl.so'): blob_fixup()
        .replace_needed('libbinder.so', 'libbinder-v32.so')
        .replace_needed('libhidlbase.so', 'libhidlbase-v32.so')
        .replace_needed('libutils.so', 'libutils-v32.so'),
    ...
    ('vendor/lib64/libspeech_enh_lib.so', 'vendor/lib64/libalsautils-v32.so',
    ...
    ('vendor/lib64/libwvhidl.so',
     'vendor/lib64/mediadrm/libwvdrmengine.so'): blob_fixup()
        .replace_needed('libprotobuf-cpp-lite-3.9.1.so',
                        'libprotobuf-cpp-full-3.9.1.so'),
    'vendor/lib64/librt_extamp_intf.so': blob_fixup()
        .replace_needed('libtinyxml2.so', 'libtinyxml2-v34.so'),
    ('vendor/lib64/mt6789/lib3a.ae.stat.so', 'vendor/lib64/mt6789/lib3a.flash.so',
     'vendor/lib64/mt6789/lib3a.sensors.color.so',
     'vendor/lib64/mt6789/lib3a.sensors.flicker.so'): blob_fixup()
    ...
    ('vendor/lib64/mt6789/libneuralnetworks_sl_driver_mtk_prebuilt.so',
     ...
     'vendor/lib64/libMegviiHum.so'): blob_fixup()
